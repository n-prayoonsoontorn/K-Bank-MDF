...
/*---------------------------------------------------------------------------------------------------
# Name: tbl_init_persist_cardlink_kb1dh010_oadctf.sql
# Area: cardlink
#----------------------------------------------------------------------------------------------------
#
# Change Revision
...
#
# Target table(s)/view(s): ${catalog}.PERSIST_CARDLINK.CARDLINK_KB1DH010_OADCTF
#--------------------------------------------------------------------------------------------------*/

-- COMMAND --

create table if not exists ${catalog}.persist_cardlink.cardlink_kb1dh010_oadctf (
	pos_dt                     	date         comment "Def(En): Position Date
Def(Th): วันที่ของข้อมูล",
	dh010_merch_nbr            	bigint       comment "Def(En): Merchant Number
Def(Th):",
...
Def(Th):",
	dh010_current_batch_nbr    	integer      comment "Def(En): Current Batch Number
Def(Th):",
	dh010_eod_cutoff_batch_nbr 	integer      comment "Def(En): Cut off Batch Number
Def(Th):",
	dh010_last_maint_date      	date         comment "Def(En): Last maintanance Date
Def(Th):",
	dh010_last_settlement_date 	date         comment "Def(En): Last settlement Date
Def(Th):",
	dh010_total_debit_nbr_1    	integer      comment "Def(En): Total Debit Number1
Def(Th):",
	dh010_total_debit_amt_1    	decimal(15,2) comment "Def(En): Total Debit Amount1
Def(Th):",
	dh010_total_credit_nbr_1   	integer      comment "Def(En): Total Credit Number1
Def(Th):",
	dh010_total_credit_amt_1   	decimal(15,2) comment "Def(En): Total Credit Amount1
Def(Th):",
	dh010_total_debit_nbr_2    	integer      comment "Def(En): Total Debit Number2
Def(Th):",
	dh010_total_debit_amt_2    	decimal(15,2) comment "Def(En): Total Debit Amount2
Def(Th):",
	dh010_total_credit_nbr_2   	integer      comment "Def(En): Total Credit Number2
Def(Th):",
	dh010_total_credit_amt_2   	decimal(15,2) comment "Def(En): Total Credit Amount2
Def(Th):",
	dh010_cur_total_debit_nbr  	smallint     comment "Def(En): Current Total Debit Number
Def(Th):",
	dh010_cur_total_debit_amt  	decimal(13,2) comment "Def(En): Current Total Debit Amount
Def(Th):",
	dh010_cur_total_credit_nbr 	smallint     comment "Def(En): Current Total Credit Number
Def(Th):",
	dh010_cur_total_credit_amt 	decimal(13,2) comment "Def(En): Current Total Credit Amount
Def(Th):",
	dh010_visa_total_nbr       	smallint     comment "Def(En): Visa Total Number
Def(Th):",
	dh010_visa_total_amount    	decimal(13,2) comment "Def(En): Visa Total Amount
Def(Th):",
	dh010_mc_total_nbr         	smallint     comment "Def(En): Authenticationcard Total Number
Def(Th):",
	dh010_mc_total_amount      	decimal(13,2) comment "Def(En): Authenticationcard Total Amount
Def(Th):",
	dh010_private_total_nbr    	smallint     comment "Def(En): Private Total Number
Def(Th):",
	dh010_private_total_amount 	decimal(13,2) comment "Def(En): Private Total Amount
Def(Th):",
	dh010_t4_previous_batch_nbr	integer      comment "Def(En): Previous Batch Number
Def(Th):",
...
Def(Th):",
	dh010_redem_count_pts      	smallint     comment "Def(En): Redemption Count
Def(Th):",
	dh010_redem_total_pts      	bigint       comment "Def(En): Redemption Total
Def(Th):",
	dh010_redem_count_voucher  	smallint     comment "Def(En): Redemption Count Voucher
Def(Th):",
	dh010_redem_total_voucher  	bigint       comment "Def(En): Redemption Total Voucher
Def(Th):",
	dh010_redem_count_discount 	smallint     comment "Def(En): Redemption Count Discount
Def(Th):",
	dh010_redem_total_discount 	integer      comment "Def(En): Redemption Total Discount
Def(Th):",
...
Def(Th):",
	dh010_trm_open_date        	date         comment "Def(En): Open Date
Def(Th):",
...
Def(Th):",
	dh010_pin_block_format     	smallint     comment "Def(En): Pin Block Format 
Def(Th):",
...
Def(Th):",
	dh010_next_profile_dte     	date         comment "Def(En): Next Profile Date
Def(Th):",
	dh010_curr_profile_id      	string       comment "Def(En): Current Profile ID
Def(Th):",
	dh010_curr_profile_dte     	date         comment "Def(En): Current Profile Date
Def(Th):",
...
Def(Th):",
	dh010_ntmk_load_dte        	date         comment "Def(En): Next Terminal Authentication Key Load Date
Def(Th):",
	dh010_ntmk_effective_dte   	date         comment "Def(En): Next Terminal Authentication Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ntpk_load_dte        	date         comment "Def(En): Next Terminal PIN Key Load Date
Def(Th):",
...
Def(Th):",
	dh010_ntak_load_dte        	date         comment "Def(En): Next Terminal Authentication Key Load Date
Def(Th):",
...
Def(Th):",
	dh010_ctmk_effective_dte   	date         comment "Def(En): Current Terminal Authentication Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ctpk_effective_dte   	date         comment "Def(En): Current Terminal PIN Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ctak_effective_dte   	date         comment "Def(En): Current Terminal Authentication Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ltmk_effective_dte   	date         comment "Def(En): Last Terminal Authentication Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ltpk_effective_dte   	date         comment "Def(En): Last Terminal PIN Key Effective Date
Def(Th):",
...
Def(Th):",
	dh010_ltak_effective_dte   	date         comment "Def(En): Last Terminal Authentication Key Effective Date
Def(Th):",
	dh010_key_last_maint_userid	string       comment "Def(En): Key Last Maintenance User ID
Def(Th):",
	dh010_key_last_maint_date  	date         comment "Def(En): Key Last Maintenance Date
Def(Th):",
	dh010_key_last_maint_time  	integer      comment "Def(En): Key Last Maintenance Time
Def(Th):",
	dh010_earliest_txn_date    	date         comment "Def(En): Earliest transaction date performed on the terminal
Def(Th):",
	dh010_earliest_txn_time    	integer      comment "Def(En): Earliest transaction time performed on the terminal
Def(Th):",
	dh010_autopost_date        	date         comment "Def(En): Autopost date on terminal
Def(Th):",
	dh010_autopost_time        	integer      comment "Def(En): Autopost time on terminal
Def(Th):",
...
) using delta partitioned by (ptn_yyyy, ptn_mm, ptn_dd) location 'abfss://${storage_persist}/${catalog}/persist_cardlink/cardlink_kb1dh010_oadctf' tblproperties (
